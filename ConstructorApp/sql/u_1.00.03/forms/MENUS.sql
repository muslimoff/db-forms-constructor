...
Insert Into FORM_ACTIONS
     ...
     Values ('MENUS', 'DEL', 'MENUS_PKG.P_DELETE_MENU', 'Папка', '48', '', '', '3', '130'
...
Insert Into FORM_ACTIONS
            ...
            ,"DEFAULT_OLD_PARAM_PREFIX", "ACTION_TYPE", "DISPLAY_NUMBER", "CONFIRM_TEXT", "HOT_KEY"
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR", "CHILD_FORM_CODE")
     Values ('MENUS', 'DELFORM', 'MENUS_PKG.P_DELETE_FORM', 'Форма', '48', '', '', '3', '130'
            ,'Вы уверенны что хотите удалить запись?', '', 'N', 'Y', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DEFAULT_OLD_PARAM_PREFIX", "ACTION_TYPE", "DISPLAY_NUMBER", "CONFIRM_TEXT", "HOT_KEY"
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR", "CHILD_FORM_CODE")
     Values ('MENUS', 'INSSIBL', 'MENUS_PKG.P_INS_SIBL', 'Брат', '47', '', '', '7', '112', 'Вы уверенны?', '', 'Y', 'Y'
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DEFAULT_OLD_PARAM_PREFIX", "ACTION_TYPE", "DISPLAY_NUMBER", "CONFIRM_TEXT", "HOT_KEY"
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR", "CHILD_FORM_CODE")
     Values ('MENUS', 'INSUPD', 'MENUS_PKG.P_INS_CHLD', 'Дочка', '47', '', '', '7', '111', 'Вы уверенны?', '', 'N', 'Y'
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DEFAULT_OLD_PARAM_PREFIX", "ACTION_TYPE", "DISPLAY_NUMBER", "CONFIRM_TEXT", "HOT_KEY"
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR", "CHILD_FORM_CODE")
     Values ('MENUS', 'UPD', 'MENUS_PKG.P_UPDATE', 'Сохранить', '46', '', '', '2', '120', 'Вы уверенны?', '', 'Y', 'Y'
            ,'');
