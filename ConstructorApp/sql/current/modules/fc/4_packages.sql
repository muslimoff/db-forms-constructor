...
Create Or Replace Package Body form_auth_cur_user_utlis_pkg As
   ...
   Begin
      ...
      DBMS_OUTPUT.put_line (SUBSTR ('Value of l_procedure_name=' || l_procedure_name, 1, 255));
      l_owner             := UPPER (aahr_orders.text_utils_pkg.word (l_procedure_name, -3, 1, '.'));
      l_package_name      := UPPER (aahr_orders.text_utils_pkg.word (l_procedure_name, -2, 1, '.'));
      l_object_name       := UPPER (aahr_orders.text_utils_pkg.word (l_procedure_name, -1, 1, '.'));
