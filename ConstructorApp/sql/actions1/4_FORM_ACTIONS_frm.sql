...
------'
            ,'Детальная Действия', 'G', 'Y', '4', '*', '*', '', '', 'Y', '58', '*', '', '', '', 'FC', '60');
...
Insert Into FORM_TABS
     ...
     Values ('FORM_ACTIONS', 'COLUMN_ACTIONS', 'FORM_COLUMN_ACTIONS', 'B', 'Действия колонки', '', '6', '2', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"STATUS_PARAMETER_NAME", "DISPLAY_IN_CONTEXT_MENU")
     Values ('FORM_ACTIONS', 'DEL', '&fc_schema_owner..FORM_ACTIONS_PKG.p_delete', 'Удалить', '48', '', '', '3', '130'
            ,'Вы уверенны что хотите удалить запись?', '', 'N', 'Y', '', '', '', '', 'Y');
...
Insert Into FORM_ACTIONS
            ...
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR", "CHILD_FORM_CODE", "URL_TEXT", "PARENT_ACTION_CODE"
            ,"STATUS_PARAMETER_NAME", "DISPLAY_IN_CONTEXT_MENU")
     Values ('FORM_ACTIONS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', '', 'Y');
...
Insert Into FORM_ACTIONS
            ...
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR", "CHILD_FORM_CODE", "URL_TEXT", "PARENT_ACTION_CODE"
            ,"STATUS_PARAMETER_NAME", "DISPLAY_IN_CONTEXT_MENU")
     Values ('FORM_ACTIONS', 'REFR', '', 'Обновить', '15', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', '', 'Y');
...
Insert Into FORM_COLUMNS$
            ("COL_NUM", "COL_TYPE", "COL_MAX_LEN", "COL_NAME", "COL_NAME_LEN", "COL_PRECISION", "COL_SCALE"
            ,"FORM_CODE", "PIMARY_KEY_FLAG", "DEFAULT_COLUMN_WIDTH", "COLUMN_DESCRIPTION")
     Values ('18', 'VARCHAR2', '1', 'DISPLAY_IN_CONTEXT_MENU', '23', '0', '0', 'FORM_ACTIONS', '', '*'
...
Insert Into FORM_COLUMNS$
            ("COL_NUM", "COL_TYPE", "COL_MAX_LEN", "COL_NAME", "COL_NAME_LEN", "COL_PRECISION", "COL_SCALE"
            ,"FORM_CODE", "PIMARY_KEY_FLAG", "DEFAULT_COLUMN_WIDTH", "COLUMN_DESCRIPTION")
     Values ('17', 'VARCHAR2', '255', 'STATUS_PARAMETER_NAME', '21', '0', '0', 'FORM_ACTIONS', '', '*'
            ,'*Имя параметра PL/SQL процедуры для передачи номера кнопки на входе и сообщения на выходе');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION")
     Values ('FORM_ACTIONS', 'DISPLAY_IN_CONTEXT_MENU', 'Отображать в контекстном меню?', '*', 'B', '1018', 'N', 'Y'
            ,'', '', '', '', '*Отображать в контекстном меню?', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'Y'
            ,'*', '', '');
