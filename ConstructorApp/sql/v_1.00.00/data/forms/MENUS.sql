...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE")
     Values ('MENUS', 'MENU_FORM_CODE', 'Форма', '200', 'S', '3', 'N', 'Y', '', '', 'FORMS', ''
            ,'*Ссылка на форму (для конечных узлов)', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE")
     Values ('MENUS', 'MENU_NAME', 'Имя', '200', 'S', '2', 'N', 'Y', '', '', '', ''
            ,'*Пользовательское наименование меню', 'N', 'N', '', '', '', '', '', '', '', '1', '', '', 'Y', '*', '');
