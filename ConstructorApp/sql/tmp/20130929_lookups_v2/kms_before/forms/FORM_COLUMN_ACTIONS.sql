...
delete from FORM_TAB_CHILDS_ALLOWED where form_code = 'FORM_COLUMN_ACTIONS';
...
Declare l_clob   Clob := ' '; Begin Update FORMS Set description = l_clob Where form_code = 'FORM_COLUMN_ACTIONS'; End;
/
