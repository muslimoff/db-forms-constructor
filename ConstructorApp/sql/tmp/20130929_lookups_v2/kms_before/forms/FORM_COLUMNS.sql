...
Insert Into FORMS
 ...
 Where NVL (:column_code, t.column_code) = t.column_code
 and NVL (:tab_code, nvl(t.editor_tab_code, ''######'')) = nvl(t.editor_tab_code, ''######'')
 --
'
            ,'Детальная Колонки', 'G', 'Y', '4', '35%', '*', '', 'B', 'Y', '392', '*', '', '', '', 'FC', '70', '', ''
            ,'');
...
Insert Into FORM_COLUMNS
     ...
     Values ('FORM_COLUMNS', 'COLUMN_CODE', 'Код', '40%', 'S', '130', 'Y', 'Y', '', '1', 'MAIN', ''
            ,'*Идентификатор поля (из запроса)', 'N', 'Y', '', 'COLUMN_DESCRIPTION', '', '1', '', '', '', '', '', 'L'
            ,'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'EDITOR_TAB_CODE', 'Закладка', '80', 'S', '170', 'N', 'N', '', '', 'MAIN', '9'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'FORM_CODE', 'Форма', '100', 'S', '120', 'Y', 'N', '', '1', 'MAIN', '9'
            ,'*Идентификатор форм', 'N', 'N', 'FORMS_LIST', '', '', '1', '', '', '', '', ':form_code', 'L', 'Y', '2'
            ,'', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'HOVER_COLUMN_CODE', 'Поле подсказки', '*', 'S', '810', 'N', 'N', '', '', 'HELP', '9'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'LOOKUP_CODE', 'Список', '*', 'S', '190', 'N', 'N', '', '', 'MAIN', '9'
