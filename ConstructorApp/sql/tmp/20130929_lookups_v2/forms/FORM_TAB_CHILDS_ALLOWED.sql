...
--   '
            ,'Динамические формы таба', 'G', 'Y', '', '*', '*', '', '', 'Y', '19', '*', '', '', '', '', '100', '', ''
            ,'');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_TAB_CHILDS_ALLOWED', 'FORM_CODE', 'Код формы', '*', 'S', '1001', 'N', 'N', '', '', '', ''
            ,'*??? ?????', 'N', 'N', '', '', '', '', '', '', '', '', ':FORM_CODE', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_TAB_CHILDS_ALLOWED', 'TAB_CODE', 'Код закладки', '*', 'S', '1002', 'N', 'N', '', '', '', '16'
...
/*  Form: FORM_TAB_CHILDS_ALLOWED. Entity: FORM_COLUMN_ACTIONS.  */
/*  Form: FORM_TAB_CHILDS_ALLOWED. Entity: FORM_COLUMN_LOOKUP_MAP.  */
...
Insert Into FORM_COLUMN_LOOKUP_MAP
     ...
     Values ('20515', 'FORM_TAB_CHILDS_ALLOWED', 'TAB_CODE', 'FORM_TABS_LIST', 'TAB_CODE', 'COLUMN', '', 'Код', '*'
            ,'1002', 'Y', 'TAB_CODE');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20516', 'FORM_TAB_CHILDS_ALLOWED', 'CHILD_FORM_CODE', 'FORMS_LIST', 'FORM_CODE', 'COLUMN', ''
            ,'Код формы', '*', '1001', 'N', 'CHILD_FORM_CODE');
