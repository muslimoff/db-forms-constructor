...
Insert Into FORMS
     ...
     Values ('LOOKUP_ATTRIBUTES', '', 'select * from LOOKUP_ATTRIBUTES la
where la.lookup_code = :lookup_code', '', 'G', 'Y', '', '*', '*', '', '', 'Y', '9', '*', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DEFAULT_OLD_PARAM_PREFIX", "ACTION_TYPE", "DISPLAY_NUMBER", "CONFIRM_TEXT", "HOT_KEY"
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR")
     Values ('LOOKUP_ATTRIBUTES', 'UPD', 'LOOKUP_ATTRIBUTES_PKG.p_ins_upd', 'Сохранить', '46', '', '', '2', '120'
            ,'Вы уверенны?', '', 'N', 'Y');
...
Insert Into FORM_ACTIONS
            ...
            ,"DEFAULT_OLD_PARAM_PREFIX", "ACTION_TYPE", "DISPLAY_NUMBER", "CONFIRM_TEXT", "HOT_KEY"
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR")
     Values ('LOOKUP_ATTRIBUTES', 'DEL', 'LOOKUP_ATTRIBUTES_PKG.p_delete', 'Удалить', '48', '', '', '3', '130'
...
Insert Into FORM_COLUMNS$
            ("COL_NUM", "COL_TYPE", "COL_MAX_LEN", "COL_NAME", "COL_NAME_LEN", "COL_PRECISION", "COL_SCALE"
            ,"FORM_CODE", "PIMARY_KEY_FLAG", "DEFAULT_COLUMN_WIDTH", "COLUMN_DESCRIPTION")
     Values ('4', 'VARCHAR2', '4', 'ATTRIBUTE_TYPE', '14', '0', '0', 'LOOKUP_ATTRIBUTES', '', '*', '**ATTRIBUTE_TYPE');
