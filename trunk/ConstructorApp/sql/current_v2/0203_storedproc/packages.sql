-- Start of DDL Script for Package FC22.APPLICATIONS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.APPLICATIONS_PKG
...
-- Start of DDL Script for Package FC22.APPS_ROLE_USERS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.APPS_ROLE_USERS_PKG

-- Start of DDL Script for Package FC22.APPS_ROLES_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- Start of DDL Script for Package FC22.FORM_ACTIONS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.FORM_ACTIONS_PKG

-- Start of DDL Script for Package FC22.FORM_AUTH_CUR_USER_UTLIS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.FORM_AUTH_CUR_USER_UTLIS_PKG

-- Start of DDL Script for Package FC22.FORM_COLUMN_ACTIONS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE

Create Or Replace Package form_column_actions_pkg As
   Procedure p_ins_upd (
...
Create Or Replace Package Body form_column_actions_pkg As
   Procedure p_ins_upd (
      p_form_column_action_id   In Out   Number
     ,p_form_code               In Out   Varchar2
     ,p_column_code             In Out   Varchar2
...
-- End of DDL Script for Package FC22.FORM_COLUMN_ACTIONS_PKG

-- Start of DDL Script for Package FC22.FORM_COLUMN_ATTR_VALS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.FORM_COLUMN_ATTR_VALS_PKG

-- Start of DDL Script for Package FC22.FORM_COLUMN_LOOKUP_MAP_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE

Create Or Replace Package form_column_lookup_map_pkg As
   Procedure p_delete (
...
Create Or Replace Package Body form_column_lookup_map_pkg As
   Procedure p_ins_upd (
      p_form_column_lookup_map_id   In Out   Number
     ,p_form_code                   In Out   Varchar2
     ,p_column_code                 In Out   Varchar2
...
-- Start of DDL Script for Package FC22.FORM_COLUMNS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
Create Or Replace Package form_columns_pkg As
   ...
   Procedure p_ins_upd (
     ...
     ,p_lookup_width                       form_columns.lookup_width%Type
     ,p_lookup_height                      form_columns.lookup_height%Type
   );
End;
/
   ...
   Begin
      ...
      Update form_columns fc
         Set fc.column_user_name = p_column_user_name
            ...
            ,lookup_width = p_lookup_width
            ,lookup_height = p_lookup_height
      ...
      If Sql%Rowcount = 0 Then
         Insert Into form_columns
                     ...
                     ,lookup_display_value, editor_on_enter_key_action, lookup_width, lookup_height)
              Values (p_form_code, p_column_code, p_column_user_name, p_column_display_size, p_column_display_number
                     ...
                     ,p_lookup_width, p_lookup_height);
      End If;
...
-- End of DDL Script for Package FC22.FORM_COLUMNS_PKG

-- Start of DDL Script for Package FC22.FORM_DML_UTILS
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.FORM_DML_UTILS

-- Start of DDL Script for Package FC22.FORM_TAB_CHILDS_ALLOWED_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE

Create Or Replace Package form_tab_childs_allowed_pkg As
   Procedure p_delete (
      p_form_tab_childs_allowed_id   In Out   Number
     ,p_form_code                    In Out   Varchar2
     ,p_tab_code                     In Out   Varchar2
     ,p_child_form_code              In Out   Varchar2
   );
...
End FORM_TAB_CHILDS_ALLOWED_PKG;
/

Create Or Replace Package Body form_tab_childs_allowed_pkg As
   Procedure p_ins_upd (
      p_form_tab_childs_allowed_id   In Out   Number
     ,p_form_code                    In Out   Varchar2
     ,p_tab_code                     In Out   Varchar2
   ...
   Begin
      Update form_tab_childs_allowed
         Set child_form_code = p_child_form_code
            ,form_code = p_form_code
            ,tab_code = p_tab_code
       Where form_tab_childs_allowed_id = p_form_tab_childs_allowed_id;

      If Sql%Rowcount = 0 Then
         Select main_sq.Nextval
           Into p_form_tab_childs_allowed_id
           From DUAL;

         Insert Into form_tab_childs_allowed
                     (form_tab_childs_allowed_id, form_code, tab_code, child_form_code)
              Values (p_form_tab_childs_allowed_id, p_form_code, p_tab_code, p_child_form_code);
      End If;
   End p_ins_upd;
...
-- End of DDL Script for Package FC22.FORM_TAB_CHILDS_ALLOWED_PKG

-- Start of DDL Script for Package FC22.FORM_TAB_PARENT_EXCLNS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.FORM_TAB_PARENT_EXCLNS_PKG

-- Start of DDL Script for Package FC22.FORM_TABS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.FORM_TABS_PKG
...
As
   ...
   Function describe_form_columns_pl (
      p_form_code              Varchar2 Default Null
     ,p_master_form_code       Varchar2 Default Null
     ,p_master_form_tab_code   Varchar2 Default Null
   )
...
/*   / *Замена переменных вида &var в xml* /
   Function replace_user_variables_clob (p_text Clob)
      Return Clob;*/
...
/*   Function replace_user_variables_clob (p_text Clob)
   ...
   Begin
      ...
      Return l_res;
   End replace_user_variables_clob;*/
   Function replace_user_variables (p_text Varchar2)
      Return Varchar2 Is
      l_res   Varchar2 (32767) := p_text;
   Begin
      l_res    := REGEXP_REPLACE (l_res, '&fc_schema_owner.', applications_pkg.get_fc_schema, 1, 0, 'i');
      l_res    := REGEXP_REPLACE (l_res, '&db_username.', User, 1, 0, 'i');
      Return l_res;
   End replace_user_variables;
...
/*  And Exists (Select 1
         ...
         form_utils_customization.customize_column_metadata (i, cc, p_master_form_code, p_master_form_tab_code);
         Pipe Row (cc);
         i                      := i + 1;
      End Loop;
...
--            Raise;
   ...
   Function get_form_pkg_clob (
     ...
     ,p_table_name      Varchar2 Default Null
      ...
      l_res   Clob;
   Begin
      l_res    := l_pkg.pkg_txt || g_cr || '/' || g_cr || l_pkg.pkg_body_txt || g_cr || '/' || g_cr;
      Return l_res;
   ...
   Begin
      ...
      Case
         ...
         Else
            Null;
      End Case;
/*      If p_master_form_tab_code Is Not Null Then
         p_column_data.column_user_name    :=
                       p_master_form_tab_code || '_' || NVL (p_column_data.column_user_name, p_column_data.column_code);
      End If;*/
...
-- Start of DDL Script for Package FC22.FORMS_ENGINE_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE

Create Or Replace Package forms_engine_pkg As
   Function fetch_query (p_form_code Varchar2, p_start_row Number, p_end_row Number)
      Return Xmltype;

   Function get_form_metadata_xml
      Return Xmltype;
End forms_engine_pkg;
/

Create Or Replace Package Body forms_engine_pkg As
/*
см. так же FORM_DML_UTILS.
Примерная последовательность действий
1. Получение метаданных формы2. Подготовка курсоров для открытия
3. Собственно чтение курсора

Состав:
Пул форм
Пул инстансов форм с курсорами
*/
   Function get_form_metadata_xml_int (p_entity_type Varchar2, p_sql_text global_params.param_value%Type)
      Return Xmltype Is
      l_result      Xmltype;
      l_ctxHandle   DBMS_XMLGEN.ctxHandle;
      l_sql_text    global_params.param_value%Type;

      Procedure setBindValue (ctx In DBMS_XMLGEN.ctxHandle, bindName In Varchar2, bindValue In Varchar2) Is
      Begin
         If REGEXP_LIKE (p_sql_text, bindName, 'i') Then
            DBMS_XMLGEN.setBindValue (ctx, bindName, bindValue);
         End If;
      Exception
         When Others Then
            DBMS_OUTPUT.put_line (SQLERRM);
      End setBindValue;
   Begin
      l_sql_text     := DBMS_LOB.SUBSTR (FORM_UTILS.replace_user_variables (p_sql_text));
      DBMS_OUTPUT.put_line (SUBSTR ('Value of l_sql_text=' || l_sql_text, 1, 255));
      l_ctxHandle    := DBMS_XMLGEN.newcontext (l_sql_text);
      DBMS_XMLGEN.setConvertSpecialChars (l_ctxHandle, True);
      DBMS_XMLGEN.setRowSetTag (l_ctxHandle, p_entity_type || 'S');
      DBMS_XMLGEN.setRowTag (l_ctxHandle, p_entity_type);
      setBindValue (l_ctxHandle, 'p_form_code', 'MENUS');
      setBindValue (l_ctxHandle, 'p_master_form_code', '');
      setBindValue (l_ctxHandle, 'p_master_form_tab_code', '');
      setBindValue (l_ctxHandle, 'p_drilldown_flag', 'N');
      --l_result       := Xmltype (FORM_UTILS.replace_user_variables_clob (DBMS_XMLGEN.getXML (l_ctxHandle)));
      --Внимание! Не выносить REGEXP_REPLACE как отдельные операторы - проблема с 10-кой!!!
      l_result       :=
         Xmltype (REGEXP_REPLACE (REGEXP_REPLACE (DBMS_XMLGEN.getXML (l_ctxHandle)
                                                 ,'&amp;fc_schema_owner.'
                                                 ,applications_pkg.get_fc_schema
                                                 ,1
                                                 ,0
                                                 ,'i'
                                                 )
      ...
      Return l_result;
   End get_form_metadata_xml_int;

   Function get_form_metadata_xml
      Return Xmltype Is
      Type t_xml Is Table Of Xmltype
         Index By global_params.param_name%Type;

      l_result    Xmltype;
      l_xmls      t_xml;
      l_gen_sql   Varchar2 (32000);
   Begin
      For cr In (With t As
                      (
                         Select a.param_name, a.param_value, a.description
                               ,DECODE (a.param_name
                                       ,'formSQL', 'FORM'                                                              --
                                       ,'ColumnsMetaDataSQL', 'COLUMN'                                                 --
                                       ,'formActionsSQL', 'ACTION'                                                     --
                                       ,'detailFormSQL', 'TAB'                                                         --
                                       ) As entity_type
                           From global_params a)
                 Select *
                   From t
                  Where t.entity_type Is Not Null) Loop
         l_xmls (cr.entity_type)    := get_form_metadata_xml_int (cr.entity_type, cr.param_value);
      End Loop;

      Select XMLELEMENT ("root", XMLCONCAT (l_xmls ('FORM'), l_xmls ('COLUMN'), l_xmls ('ACTION'), l_xmls ('TAB')))
        Into l_result
        From DUAL;

      Return l_result;
   End get_form_metadata_xml;
...
--      DBMS_OUTPUT.put_line (p_text);
   ...
   --Функция для преобразования значения поля в XML-тег.
   --Заготовка. Сюда-же в дальнейшем - преобразования типов в xml из метаданных DBMS_SQL.desc_tab
   Function column_value_tag (c In Integer, Position In Integer)
      Return Clob Is
      l_tmp_var      Varchar2 (4000);
      l_result_txt   Varchar2 (4000);
   Begin
      DBMS_SQL.COLUMN_VALUE (c, Position, l_tmp_var);

      --Оборачивание в CDATA для сохранения форматирования и спец.символов. Обработку оставить только для текстовых
      If     l_tmp_var Is Not Null
         And (   Length (TRANSLATE (l_tmp_var, '1<>&"' || CHR (10) || CHR (13) || CHR (0) || CHR (8), '1')) !=
                                                                                                      Length (l_tmp_var)
              Or l_tmp_var Like '%--%'
             ) Then
         l_tmp_var    := '<![CDATA[' || l_tmp_var || ']]>';
      End If;

      l_result_txt    := '<' || 'c n="' || (Position || '') || '">' || l_tmp_var || '</c>';

      --Тут самый медленный кусок - пока оставил до решения проблемы с невалидными символами v$session.osuser
      Begin
         l_result_txt    := Xmltype (l_result_txt).getClobVal ();
      Exception
         When Others Then
            l_result_txt    :=
                      '<' || 'c n="' || (Position || '') || '"><![CDATA[' || SQLERRM || '
' ||                  l_tmp_var || '
]]></c>';
      End;
...
/*   Exception
      When Others Then
--         DBMS_OUTPUT.put_line ('Value of l_result_txt=' || l_result_txt);
         Raise;*/
   End column_value_tag;

   Function get_prepared_query_cur_inst
      Return Number Is
   Begin
      Return Null;
   End get_prepared_query_cur_inst;

   --   public RowsArr fetch(String sortBy, int startRow, int endRow, Map<?, ?> filterValues, boolean forceFetch) {
   Function fetch_query (p_form_code Varchar2, p_start_row Number, p_end_row Number)
      Return Xmltype Is
      l_col_matadata   FORM_UTILS.columns_t;
      --
      cur              Number;
      col_count        Pls_integer;
      l_sql_text       forms.sql_text%Type;
      l_desc_tab       DBMS_SQL.desc_tab;
      l_tmp_var        Varchar2 (4000);
      l_ignore         Integer;
      l_clob           Clob                  := EMPTY_CLOB ();
      l_clob_tmp       Clob                  := EMPTY_CLOB ();
      l_rows_counter   Integer               := 0;
      l_row_xml        Xmltype;
      l_cols_xml       Clob;
      l_binds_xml      Xmltype;
   Begin
      ...
      Log ('step 2');
      l_sql_text    := form_utils.get_extended_sql_text (l_sql_text);
      --l_sql_text    := UPPER (l_sql_text);
      Log ('step 3. l_sql_text=' || l_sql_text);
/*
      Select   *
      Bulk Collect Into l_col_matadata
          From Table (form_utils.describe_form_columns_pl (p_form_code
                                                          ,Null                                    --:p_master_form_code
                                                          ,Null                                --:p_master_form_tab_code
                                                          )
                     )
      Order By form_code, column_display_number, column_code;*/
      cur           := DBMS_SQL.open_cursor;
      DBMS_SQL.parse (cur, l_sql_text, DBMS_SQL.native);
      DBMS_SQL.describe_columns (cur, col_count, l_desc_tab);
      Log ('step 4');
      l_tmp_var     := Null;

      For i In l_desc_tab.First .. l_desc_tab.Last Loop
--         Log (l_desc_tab (i).col_name || '; ' || 'Value of i=' || i);
         DBMS_SQL.define_column (cur, i, l_tmp_var, 4000);
         l_cols_xml    := l_cols_xml || '<c n="' || i || '" name="' || l_desc_tab (i).col_name || '"/>';
--         Log ('step 5.2');
      End Loop;

      l_cols_xml    := '<columns>' || l_cols_xml || '</columns>';
--
      Log ('step 5');

      --Бинды - пока для теста автомепим
      For Binds In (Select Distinct p_form_code form_code, m.Position
                                   ,form_utils.get_datatype_as_string (m.datatype) datatype
                                                                                           --
                                    , m.max_length, m.array_len, m.bind_name
                               From v$sql_bind_metadata m, v$sql_cursor c
                              Where c.child_handle = m.address
                           ...
                           Order By m.Position) Loop
--         g_bind_variables (Binds.form_code || Binds.Position)    := Binds;
         DBMS_SQL.bind_variable (cur, binds.bind_name, '');
         DBMS_SQL.variable_value (cur, binds.bind_name, l_tmp_var);
         Log (binds.bind_name || ': ' || l_tmp_var);
      End Loop;

      Log ('step 6');
--
--
      l_ignore      := DBMS_SQL.Execute (cur);
      Log ('step 7');
      ...
      Loop
         ...
         If DBMS_SQL.FETCH_ROWS (cur) > 0 Then
            l_rows_counter    := l_rows_counter + 1;

            If l_rows_counter Between p_start_row And p_end_row Then
               For i In l_desc_tab.First .. l_desc_tab.Last Loop
                  -- get column values of the row
--                  DBMS_SQL.COLUMN_VALUE (cur, i, l_tmp_var);
                  Log ('col_name:' || l_desc_tab (i).col_name || '; i:' || i || '; value: ' || l_tmp_var);
                  l_clob_tmp    := l_clob_tmp || column_value_tag (cur, i);
               End Loop;

               l_clob    := l_clob || '<row r="' || (l_rows_counter || '') || '">' || l_clob_tmp || '</row>';
            End If;
         Else
      ...
      l_clob        := '<data>' || l_cols_xml || '<rowset>' || l_clob || '</rowset>' || '</data>';
      Log ('step 10');
--      DBMS_OUTPUT.put_line (SUBSTR (l_clob, -100, 4000));
...
--         Raise;
         Return Xmltype ('<error><sqlerrm>' || SQLERRM || '</sqlerrm><clob><![CDATA[' || l_clob || ']]></clob></error>');
   End fetch_query;
End forms_engine_pkg;
/

-- End of DDL Script for Package FC22.FORMS_ENGINE_PKG

-- Start of DDL Script for Package FC22.FORMS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.FORMS_PKG

-- Start of DDL Script for Package FC22.FORMS2_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
Create Or Replace Package Body forms2_pkg As
   Procedure p_insert (p_user_name In Out Varchar2, p_code Out Varchar2, p_is_folder Out Varchar2) Is
      ...
      l_table_descr            Varchar2 (100 Char);
   Begin
      ...
      Begin
         raise_application_error
                             (-20001
                             ,'Автогенерация в момент создания формы - зло. Пользуйтесь копипастом генеренного пакета!'
                             );
...
-- End of DDL Script for Package FC22.FORMS2_PKG

-- Start of DDL Script for Package FC22.ICONS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.ICONS_PKG
...
-- Start of DDL Script for Package FC22.LOOKUP_VALUES_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.LOOKUP_VALUES_PKG

-- Start of DDL Script for Package FC22.LOOKUPS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.LOOKUPS_PKG

-- Start of DDL Script for Package FC22.MATRIX_REP_DEMO_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.MATRIX_REP_DEMO_PKG

-- Start of DDL Script for Package FC22.MENUS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- Start of DDL Script for Package FC22.TEST_FORM_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE

Create Or Replace Package test_form_pkg As
...
-- End of DDL Script for Package FC22.TEST_FORM_PKG

-- Start of DDL Script for Package FC22.TEXT_UTILS
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.TEXT_UTILS

-- Start of DDL Script for Package FC22.TEXT_UTILS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.TEXT_UTILS_PKG

-- Start of DDL Script for Package FC22.USERS_PKG
-- Generated 17.11.2013 1:23:32 from FC22@XE
...
-- End of DDL Script for Package FC22.USERS_PKG
