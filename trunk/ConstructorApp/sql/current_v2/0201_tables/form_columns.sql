...
/
Comment On Column form_columns.lookup_height Is 'Высота лукапа. Приоритетнее, чем поле FORMS.LOOKUP_WIDTH'
/
Comment On Column form_columns.lookup_width Is 'Ширина лукапа. Приоритетнее, чем поле FORMS.LOOKUP_WIDTH'
/
...
Disable Novalidate
/
rem Alter Table form_columns Add Constraint form_tabs_fk Foreign Key (form_code, editor_tab_code) References form_tabs (form_code,tab_code)
