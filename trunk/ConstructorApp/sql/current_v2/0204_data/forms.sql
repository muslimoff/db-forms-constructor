...
Insert Into FORMS
  ...
  From &fc_schema_owner..forms_v a'
            ,'Список Формы', 'G', 'Y', '11', '*', '*', '', '', 'Y', '32', '*', '', '', '300', 'FC', '10', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORMS_LIST', 'FORM_CODE', 'Код формы', '*', 'S', '1001', 'N', 'N', '', '', '', '', '*Идентификатор форм'
            ,'N', 'N', '', '', '', '1', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORMS_LIST', 'FORM_CODE_DISPLAY', 'Код формы', '*', 'S', '1005', 'N', 'Y', '', '', '', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORMS_LIST', 'HOT_KEY', 'Горячая клавиша', '*', 'S', '1003', 'N', 'N', '', '', '', ''
...
'
            ,'Детальная Вкладки', 'G', 'Y', '4', '*', '*', '', '', 'Y', '84', '*', '', '', '', 'FC', '10', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_TABS', 'CHILD_FORM_CODE', 'Дочерняя форма', '*', 'S', '1003', 'N', 'Y', '', '', '', '16'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_TABS', 'ICON_ID', 'Иконка', '*', 'N', '1007', 'N', 'Y', '', '', '', '16', '**ICON_ID', 'N', 'N'
            ,'ICONS', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
     ...
     Values ('20513', 'FORM_TABS', 'ICON_ID', 'ICONS', 'ICON_ID', 'COLUMN', '', 'Код иконки', '10%', '1001', 'Y'
            ,'ICON_ID');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20514', 'FORM_TABS', 'CHILD_FORM_CODE', 'FORMS_LIST', 'FORM_CODE', 'COLUMN', '', 'Код формы', '*', '1001'
            ,'N', 'CHILD_FORM_CODE');
...
Insert Into FORM_ACTIONS
     ...
     Values ('ICONS', 'DEL', '&fc_schema_owner..ICONS_PKG.p_delete', 'Удалить', '48', '', '', '3', '130'
            ,'Вы уверены что хотите удалить запись?', '', 'Y', 'N', '', '', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('ICONS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', '', '', ''
            ,'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('ICONS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('ICONS', 'NEXT', '', 'Вперед', '53', '', '', '6', '40', '', '', 'Y', 'Y', '', '', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('ICONS', 'PREV', '', 'Назад', '54', '', '', '5', '30', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('ICONS', 'REFRESH', '', 'Обновить', '55', '', '', '4', '10', '', 'Alt+R', 'N', 'Y', '', '', '', 'Y', 'Y'
            ,'', '', '');
...
'
            ,'Список Списки', 'G', 'Y', '11', '*', '*', '', '', 'Y', '35', '*', '', '', '', 'FC', '10', '', '', '');
...
--'
            ,'Списки значений', 'G', 'Y', '', '*', '*', '', '', 'Y', '22', '*', '', '', '', 'FC', '10', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_VALUES_LIST', 'REFR', '', 'Обновить', '15', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', 'Y'
            ,'Y', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('LOOKUP_VALUES_LIST', 'LOOKUP_DISPLAY_VALUE', 'Значение', '*', 'S', '1002', 'N', 'Y', '', '', '', ''
            ,'*Поле запроса, отображаемое пользователю - для длинных лукапов', 'N', 'N', '', '', '', '2', '', '', ''
            ,'1', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('LOOKUP_VALUES_LIST', 'LOOKUP_VALUE_CODE', 'Код', '30%', 'S', '1001', 'N', 'N', '', '', '', ''
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', '', '', ''
            ,'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'REFR', '', 'Обновить', '15', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'XML', '', 'выгрузить XML', '103', '', '', '15', '250', '', '', 'N', 'N', ''
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'XMLP', '', 'Печать(XMLP-RTF) :report_type_code', '43', '', '', '15', '200', '', '', 'N', 'N'
            ,''
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'XMLP-HTML', '', 'Печать(XMLP-HTML) :report_type_code', '', '', '', '15', '230', '', '', 'N'
            ,'N', ''
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'XMLP-PDF', '', 'Печать(XMLP-PDF) :report_type_code', '43', '', '', '15', '220', '', '', 'N'
            ,'N', ''
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'XMLP-XLS', '', 'Печать(XMLP-XLS) :report_type_code', '43', '', '', '15', '210', '', '', 'N'
            ,'N', ''
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('REPORTS', 'tmp', '', ':REPORT_TYPE_CODE - дочернюю форму в табе', '', '', '', '10', '140', 'Вы уверены?'
            ,'', 'N', 'N', '', '', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('USERS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', '', '', ''
            ,'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('USERS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('USERS', 'REFR', '', 'Обновить', '15', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_ATTRIBUTES', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y'
            ,'', '', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_ATTRIBUTES', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y'
            ,'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_ATTRIBUTES', 'REFR', '', 'Обновить', '15', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', 'Y'
            ,'Y', '', '', '');
...
Insert Into FORMS
     ...
     Values ('LOOKUP_VALUES', '', 'SELECT * FROM &fc_schema_owner..lookup_values a where a.lookup_code=:lookup_code'
            ,'Детальная Значения списков', 'G', 'Y', '4', '*', '45%', 'B', 'B', 'Y', '57', '*', '', '', '', 'FC', '40'
            ,'', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_VALUES', 'CLOSE_FORM', '', 'Закрыть форму', '48', '', '', '17', '500', 'Вы уверены?', '', 'N', 'Y'
            ,'', '', '', 'Y', 'N', '', '', '');
...
Insert Into FORM_ACTIONS
     ...
     Values ('LOOKUP_VALUES', 'DEL', '&fc_schema_owner..LOOKUP_VALUES_PKG.P_DELETE', 'Удалить', '48', '', '', '3'
            ,'130', 'Вы уверены что хотите удалить запись?', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_VALUES', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', ''
            ,'', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_VALUES', 'GRID_PRINT', '', 'Печать', '43', '', '', '14', '330', '', '', 'N', 'N', '', '', '', 'Y'
            ,'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_VALUES', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y'
            ,'', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_VALUES', 'REFRESH', '', 'Обновить', '15', '', '', '4', '150', '', '', 'N', 'Y', '', '', '', 'Y'
            ,'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUP_VALUES', 'TEST', '', 'Скрыть табики', '101', '', '', '99', '400', '', '', 'N', 'Y', '', '', ''
            ,'Y', 'Y', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('LOOKUP_VALUES', 'LOOKUP_CODE', 'Код списка', '*', 'S', '1001', 'Y', 'N', '', '1', '', ''
            ,'*Текстовый идентфикатор (ID)', 'N', 'N', '', '', '', '1', '', '', '', '', ':lookup_code', 'L', 'Y', '*'
            ,'', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('LOOKUP_VALUES', 'LOOKUP_VALUE_CODE', 'Код', '20%', 'S', '1002', 'Y', 'Y', '', '1', '', ''
...
---',        'Списки', 'G', 'Y', '28', '30%', '*', 'L', '', 'N', '76', '120', '', 'DET_NEW_WND', '', 'FC', '50', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUPS', 'CLOSE_FORM', '', 'Закрыть текущую форму', '48', '', '', '17', '210', 'Вы уверены?', '', 'N'
            ,'Y', '', '', '', 'Y', 'N', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUPS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', '', '', 'N', 'Y', '', '', '', 'Y', 'Y'
            ,'', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUPS', 'EXPORT', '', 'Экспорт', '122', '', '', '12', '200', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', ''
            ,'', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUPS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUPS', 'NEXT', '', 'Вперед', '53', '', '', '6', '190', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUPS', 'PREV', '', 'Назад', '54', '', '', '5', '180', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUPS', 'REFRESH', '', 'Обновить', '55', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', ''
            ,'', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('LOOKUPS', 'TEST', '', 'Скрыть табики', '', '', '', '99', '999', '', '', 'N', 'Y', '', '', '', 'Y', 'Y'
            ,'', '', '');
...
Insert Into FORM_COLUMNS$
            ("COL_NUM", "COL_TYPE", "COL_MAX_LEN", "COL_NAME", "COL_NAME_LEN", "COL_PRECISION", "COL_SCALE"
            ,"FORM_CODE", "PIMARY_KEY_FLAG", "DEFAULT_COLUMN_WIDTH", "COLUMN_DESCRIPTION")
     Values ('4', 'VARCHAR2', '1', 'SEARCH_MODE_CODE', '16', '0', '0', 'LOOKUPS', '', '120', '*Режим поиска');
/*  Form: LOOKUPS. Entity: FORM_COLUMNS.  */
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('LOOKUPS', 'APPS_CODE', 'Приложение', '120', 'S', '1003', 'N', 'N', '', '', '', '', 'Приложение', 'N', 'N'
            ,'', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('LOOKUPS', 'DESCRIPTION', 'Описание', '120', 'CLOB', '1005', 'N', 'N', '', '', '', '', 'Описание', 'N'
            ,'N', '', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('LOOKUPS', 'SEARCH_MODE_CODE', 'Режим поиска', '120', 'S', '1004', 'N', 'N', '', '', '', ''
            ,'*Режим поиска', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORMS
 ...
 Where DECODE (:p_$master_form_code, ''FORMS'', :form_code, ''FORMS2'', :form_code_for_filter,''MENUS'',:form_code, a.form_code) = a.form_code
   and nvl(:action_code, a.action_code) = a.action_code'
            ,'Детальная Действия', 'G', 'Y', '4', '40%', '*', '', '', 'Y', '177', '*', '', '', '', 'FC', '60', '', ''
            ,'400');
...
Insert Into FORM_ACTIONS
     ...
     Values ('FORM_ACTIONS', 'DEL', '&fc_schema_owner..FORM_ACTIONS_PKG.p_delete', 'Удалить', '48', '', '', '3', '130'
            ,'Вы уверены что хотите удалить запись?', '', 'Y', 'Y', '', '', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORM_ACTIONS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', '', ''
            ,'', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORM_ACTIONS', 'EXP', '', 'Экспорт', '122', '', '', '12', '200', 'Вы уверены?', '', 'N', 'N', '', '', ''
            ,'Y', 'N', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_ACTIONS', 'CHILD_FORM_CODE', 'Дочерняя форма', '*', 'S', '120', 'N', 'N', '', '', 'DETAILS', '16'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_ACTIONS', 'ICON_ID', 'Иконка', '*', 'N', '50', 'N', 'Y', '', '', 'DETAILS', '16', '**ICON_ID', 'N'
            ,'Y', 'ICONS', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_ACTIONS', 'STATUS_BUTTON_PARAM', 'Параметр: № кнопки', '*', 'S', '150', 'N', 'N', '', '', 'DETAILS'
            ,'16', '*Имя параметра PL/SQL процедуры для передачи номера кнопки для (статуса WARN)', 'N', 'Y'
            ,'COLUMNS_LIST', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_ACTIONS', 'STATUS_MSG_LEVEL_PARAM', 'Параметр: статус', '*', 'S', '160', 'N', 'N', '', '', 'DETAILS'
            ,'16'
            ,'*Имя параметра PL/SQL процедуры для передачи статуса выполнения (Пусто-OK, 1-WARN, 2-ERR, 3-CANCEL)', 'N'
            ,'Y', 'COLUMNS_LIST', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_ACTIONS', 'STATUS_MSG_TXT_PARAM', 'Параметр: текст сообщ.', '*', 'S', '170', 'N', 'N', '', ''
            ,'DETAILS', '16', '*Имя параметра PL/SQL процедуры для передачи текста сообщения и кнопок', 'N', 'Y'
            ,'COLUMNS_LIST', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20506', 'FORM_ACTIONS', 'ICON_ID', 'ICONS', 'ICON_ID', 'COLUMN', '', 'Код иконки', '10%', '1001', 'Y'
            ,'ICON_ID');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20507', 'FORM_ACTIONS', 'CHILD_FORM_CODE', 'FORMS_LIST', 'FORM_CODE', 'COLUMN', '', 'Код формы', '*'
...
--
'
            ,'Детальная Колонки', 'G', 'Y', '4', '35%', '*', '', 'B', 'Y', '404', '*', '', '', '', 'FC', '70', '', ''
            ,'');
...
Insert Into FORM_TABS
            ("FORM_CODE", "TAB_CODE", "CHILD_FORM_CODE", "TAB_POSITION", "TAB_NAME", "NUMBER_OF_COLUMNS", "ICON_ID"
            ,"TAB_TYPE", "TAB_DISPLAY_NUMBER")
     Values ('FORM_COLUMNS', 'ACTIONS', 'FORM_COLUMN_ACTIONS', 'R', 'Действия', '', '', '2', '4');
...
Insert Into FORM_TABS
            ("FORM_CODE", "TAB_CODE", "CHILD_FORM_CODE", "TAB_POSITION", "TAB_NAME", "NUMBER_OF_COLUMNS", "ICON_ID"
            ,"TAB_TYPE", "TAB_DISPLAY_NUMBER")
     Values ('FORM_COLUMNS', 'LOOKUP_MAP', 'FORM_COLUMN_LOOKUP_MAP', 'R', 'SQL-Лукапы', '', '15', '2', '5');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORM_COLUMNS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', '', ''
            ,'', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORM_COLUMNS', 'EXP', '', 'Экспорт', '43', '', '', '12', '200', 'Вы уверены?', '', 'N', 'Y', '', '', ''
            ,'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORM_COLUMNS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', ''
            ,'', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORM_COLUMNS', 'REFRESH', '', 'Обновить', '15', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', 'Y', 'Y'
            ,'', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'COLUMN_CODE', 'Код', '40%', 'S', '130', 'Y', 'Y', '', '1', 'MAIN', ''
            ,'Идентификатор поля', 'N', 'Y', '', 'COLUMN_DESCRIPTION', '', '1', '', '', '', '', '', 'L', 'Y', '*', ''
            ,'', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'COLUMN_DATA_TYPE', 'Тип данных', '40', 'S', '150', 'N', 'N', '', '', 'MAIN', '8'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'COLUMN_DESCRIPTION', 'Описание', '150', 'S', '820', 'N', 'N', '', '', 'HELP', ''
...
Insert Into FORM_COLUMNS
     ...
     Values ('FORM_COLUMNS', 'COLUMN_DISPLAY_NUMBER', '№', '22', 'N', '110', 'N', 'Y', '', '', 'MAIN', ''
            ,'Порядковый номер отображения в таблице', 'N', 'Y', '', '', '', '', '', '', '', '1', '', 'L', 'N', '1', ''
            ,'', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'COLUMN_DISPLAY_SIZE', 'Ширина', '40', 'S', '160', 'N', 'N', '', '', 'MAIN', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'COLUMN_USER_NAME', 'Польз. имя', '*', 'S', '140', 'N', 'Y', '', '', 'MAIN', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'DEFAULT_ORDERBY_NUMBER', '№ сортировки', '*', 'S', '230', 'N', 'N', '', '', 'MAIN', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'DEFAULT_VALUE', 'По умолчанию', '*', 'S', '240', 'N', 'N', '', '', 'MAIN', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'EDITOR_COLS_SPAN', 'Редактор - кол-во колонок', '*', 'S', '470', 'N', 'N', '', '', 'ADD'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'EDITOR_END_ROW_FLAG', 'Редактор - с конца строки', '*', 'B', '480', 'N', 'N', '', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'EDITOR_HEIGHT', 'Высота поля', '*', 'S', '440', 'N', 'N', '', '', 'ADD', ''
            ,'*Высота поля в закладке редактирования', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'Y', '*', ''
            ,'', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'EDITOR_ON_ENTER_KEY_ACTION', 'Действие по нажатию Enter', '*', 'S', '490', 'N', 'N', ''
            ,'', 'ADD', '16', '*Действие по нажатию Enter', 'N', 'N', 'DBLCLICK_FORM_ACT_LIST', '', '', '', '', '', ''
            ,'', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'EDITOR_TAB_CODE', 'Закладка', '80', 'S', '170', 'N', 'N', '', '', 'MAIN', '16'
            ,'*Идентификатор закладки', 'N', 'N', 'FORM_TABS_LIST', '', '', '', '', '', '', '', '', 'L', 'Y', '*', ''
            ,'', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'EXISTS_IN_METADATA_FLAG', 'В настройках?', '*', 'B', '142', 'N', 'Y', '', '', '', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'EXISTS_IN_QUERY_FLAG', 'В запросе?', '*', 'B', '144', 'N', 'Y', '', '', '', ''
            ,'Существует ли поле в запросе?', 'N', 'Y', '', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', ''
            ,'');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'FIELD_TYPE', 'Тип поля', '40', 'S', '180', 'N', 'N', '', '', 'MAIN', '10'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'FORM_CODE', 'Форма', '100', 'S', '120', 'Y', 'N', '', '1', 'MAIN', '16'
            ,'Идентификатор формы', 'N', 'Y', 'FORMS_LIST', '', '', '1', '', '', '', '', ':form_code', 'L', 'Y', '2'
            ,'', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'HOVER_COLUMN_CODE', 'Поле подсказки', '*', 'S', '810', 'N', 'N', '', '', 'HELP', '16'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'IS_FROZEN_FLAG', 'Заморозить', '80', 'B', '200', 'N', 'N', '', '', 'MAIN', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'LOOKUP_CODE', 'Список', '*', 'S', '190', 'N', 'N', '', '', 'MAIN', '16'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'LOOKUP_DISPLAY_VALUE', 'Списки: отображаемое поле', '*', 'S', '500', 'N', 'N', '', ''
            ,'ADD', '16', '*Поле запроса, отображаемое пользователю - для длинных лукапов', 'N', 'N', 'COLUMNS_LIST'
            ,'', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'LOOKUP_FIELD_TYPE', 'Тип поля в списке', '*', 'S', '600', 'N', 'N', '', '', 'ADD', '8'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'LOOKUP_HEIGHT', 'Высота лукапа', '*', 'N', '520', 'N', 'N', '', '', 'ADD', ''
            ,'*Высота лукапа', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'Y', '1', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'LOOKUP_NAME', 'Пользовательское имя', '*', 'S', '9000', 'N', 'N', '', '', '', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'LOOKUP_WIDTH', 'Ширина лукапа', '*', 'N', '510', 'N', 'N', '', '', 'ADD', ''
            ,'Ширина лукапа', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'N', '1', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'PIMARY_KEY_FLAG', 'Первичн. ключ', '80', 'B', '210', 'N', 'N', '', '', 'MAIN', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'SHOW_HOVER_FLAG', 'Подсказка', '80', 'B', '800', 'N', 'N', '', '', 'HELP', ''
            ,'*Показывать всплывающую подсказку-значение поля', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'Y'
            ,'*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'SHOW_ON_GRID', 'Отображать в таблице', '80', 'B', '220', 'N', 'N', '', '', 'MAIN', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'TEXT_MASK', 'Маска', '*', 'S', '450', 'N', 'N', '', '', 'ADD', ''
            ,'*Текстовая маска для поля. См. описание в интерфейсе', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L'
            ,'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'TREE_FIELD_TYPE', 'Тип для дерева', '40', 'S', '400', 'N', 'N', '', '', 'ADD', '8'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'TREE_INITIALIZATION_VALUE', 'Иниц. дерева', '80', 'S', '410', 'N', 'N', '', '', 'ADD', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('FORM_COLUMNS', 'VALIDATION_REGEXP', 'Валидация', '*', 'S', '460', 'N', 'N', '', '', 'ADD', ''
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20494', 'FORM_COLUMNS', 'FORM_CODE', 'FORMS_LIST', 'FORM_CODE', 'COLUMN', '', 'Код формы', '*', '1001'
            ,'N', 'FORM_CODE');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20495', 'FORM_COLUMNS', 'EDITOR_TAB_CODE', 'FORM_TABS_LIST', 'TAB_CODE', 'COLUMN', '', 'Код', '*', '1002'
            ,'Y', 'EDITOR_TAB_CODE');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20496', 'FORM_COLUMNS', 'LOOKUP_CODE', 'LOOKUPS_LIST', 'LOOKUP_CODE', 'COLUMN', '', 'Код', '*', '10', 'Y'
            ,'LOOKUP_CODE');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
     ...
     Values ('20497', 'FORM_COLUMNS', 'EDITOR_ON_ENTER_KEY_ACTION', 'DBLCLICK_FORM_ACT_LIST', 'ACTION_CODE', 'COLUMN'
            ,'', 'Код', '*', '1001', 'Y', 'EDITOR_ON_ENTER_KEY_ACTION');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORM_COLUMN_ATTR_VALS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N'
            ,'Y', '', '', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORM_COLUMN_ATTR_VALS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y'
            ,'Y', '', '', '');
...
'
            ,'Меню для роли', 'T', 'Y', '23', '*', '*', '', '', 'Y', '27', '*', '', '', '', 'FC', '90', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('APPS_ROLE_MENUS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', ''
            ,'', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('APPS_ROLE_MENUS', 'FORM_CODE', 'Форма', '*', 'S', '1005', 'N', 'Y', '', '', '', '16'
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20500', 'APPS_ROLE_MENUS', 'FORM_CODE', 'FORMS_LIST', 'FORM_CODE', 'COLUMN', '', 'Код формы', '*', '1001'
            ,'N', 'FORM_CODE');
...
'
            ,'Пользователи роли', 'G', 'Y', '32', '*', '*', '', '', 'Y', '10', '*', '', '', '', 'FC', '90', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('APPS_ROLE_USERS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', ''
            ,'', '', 'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('APPS_ROLE_USERS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y'
            ,'', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('APPS_ROLE_USERS', 'REFR', '', 'Обновить', '15', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', 'Y', 'Y'
            ,'', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORMS2', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', '', '', ''
            ,'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORMS2', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORMS2', 'REFR', '', 'Обновить', '15', '', '', '4', '10', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('FORMS2', 'АДЕК', '', 'Фильтр', '25', '', '', '9', '190', 'Вы уверены?', '', 'N', 'Y', '', '', '', 'Y'
            ,'Y', '', '', '');
...
'
            ,'Конструктор', 'T', 'Y', '28', '30%', '*', '', 'T', 'N', '390', '*', '', '', '', 'FC', '100', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('MENUS', 'EDIT', '', 'Редактировать', '50', '', '', '8', '115', 'Вы уверены?', '', 'N', 'Y', '', '', ''
            ,'Y', 'Y', '', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('MENUS', 'INS', '', 'Создать', '47', '', '', '1', '110', '', '', 'N', 'Y', '', '', '', 'Y', 'Y', '', ''
            ,'');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('MENUS', 'REFR', '', 'Обновить все', '15', '', '', '4', '10', '', 'Alt+R', 'N', 'Y', '', '', '', 'Y', 'Y'
            ,'', '', '');
...
Insert Into FORM_ACTIONS
            ...
            ,"DISPLAY_IN_CONTEXT_MENU", "AUTOCOMMIT", "STATUS_BUTTON_PARAM", "STATUS_MSG_LEVEL_PARAM"
            ,"STATUS_MSG_TXT_PARAM")
     Values ('MENUS', 'REFRESH_NODE', '', 'Обновить узел', '15', '', '', '18', '20', '', '', 'Y', 'Y', '', '', '', 'Y'
            ,'N', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'ACTION_CODE', 'Действие', '*', 'S', '1018', 'N', 'N', '', '', '', '', 'Действие', 'N', 'N', ''
            ,'', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'COLUMN_CODE', 'Столбец', '*', 'S', '1017', 'N', 'N', '', '', '', '', 'Столбец', 'N', 'N', '', ''
            ,'', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'FORM_CODE', 'Форма', '*', 'S', '210', 'N', 'N', '', '', '', '', '*??? ?????', 'N', 'N', '', ''
            ,'', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'LOOKUP_CODE', 'Лукап', '*', 'S', '1018', 'N', 'N', '', '', '', '', 'Лукап', 'N', 'N', '', '', ''
            ,'', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'MENU_CODE', 'Код меню', '150', 'S', '50', 'Y', 'N', '', '1', '', '6', '*Код меню', 'N', 'N', ''
            ,'', '', '1', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'MENU_FORM_CODE', 'Код формы', '200', 'S', '20', 'N', 'N', '', '', '', '16'
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'MENU_FORM_NAME', 'Форма', '200', 'S', '25', 'N', 'Y', '', '', '', '16'
            ,'Имя формы (для конечных узлов)', 'N', 'N', 'FORMS_LIST', '', '', '', '', '', '', '', '', 'L', 'Y', '*'
            ,'', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'MENU_NAME', 'Имя', '300', 'S', '10', 'N', 'Y', '', '', '', ''
            ,'*Пользовательское наименование меню', 'Y', 'Y', '', 'HINT', '', '', '', '', '', '1', '', 'L', 'Y', '*'
            ,'', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'MENU_POSITION', 'Позиция в узле', '120', 'N', '30', 'N', 'Y', '', '', '', ''
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'PARENT_MENU_CODE', 'Ссылка на пункт меню-родитель', '*', 'S', '60', 'N', 'N', '', '2', '', ''
            ,'*Ссылка на пункт меню-родитель', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', ''
            ,'');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'SHOW_IN_NAVIGATOR', 'Показывать в навигаторе', '150', 'B', '40', 'N', 'Y', '', '', '', ''
            ,'*Показывать в навигаторе', 'N', 'N', '', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMNS
            ...
            ,"DEFAULT_ORDERBY_NUMBER", "DEFAULT_VALUE", "EDITOR_TITLE_ORIENTATION", "EDITOR_END_ROW_FLAG"
            ,"EDITOR_COLS_SPAN", "LOOKUP_DISPLAY_VALUE", "EDITOR_ON_ENTER_KEY_ACTION", "LOOKUP_WIDTH", "LOOKUP_HEIGHT")
     Values ('MENUS', 'TAB_CODE', 'Вкладка', '*', 'S', '220', 'N', 'N', '', '', '', '', '*????????????? ????????', 'N'
            ,'N', '', '', '', '', '', '', '', '', '', 'L', 'Y', '*', '', '', '', '');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20490', 'MENUS', 'MENU_FORM_CODE', 'FORMS_LIST', 'FORM_NAME', 'COLUMN', '', 'Форма', '*', '1002', 'Y'
            ,'MENU_FORM_NAME');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20488', 'MENUS', 'MENU_FORM_NAME', 'FORMS_LIST', 'FORM_CODE', 'COLUMN', '', 'Код формы', '*', '1001', 'N'
            ,'MENU_FORM_CODE');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20489', 'MENUS', 'MENU_FORM_NAME', 'FORMS_LIST', 'FORM_NAME', 'COLUMN', '', 'Форма', '*', '1002', 'Y'
            ,'MENU_FORM_NAME');
...
Insert Into FORM_COLUMN_LOOKUP_MAP
            ...
            ,"MAPPING_TYPE", "CONSTANT_VALUE", "COLUMN_USER_NAME", "COLUMN_DISPLAY_SIZE", "COLUMN_DISPLAY_NUMBER"
            ,"SHOW_ON_GRID", "COLUMN_CODE_TO_MAPPING")
     Values ('20479', 'MENUS', 'MENU_FORM_CODE', 'FORMS_LIST', 'FORM_CODE', 'COLUMN', '', 'Код формы', '*', '1001', 'N'
            ,'MENU_FORM_CODE');
