...
Insert Into FORM_ACTIONS
     ...
     Values ('APPS_ROLE_USERS', 'DEL', 'APPS_ROLE_USERS_PKG.p_delete', 'Удалить', '48', '', '', '3', '130'
...
Insert Into FORM_ACTIONS
            ...
            ,"DEFAULT_OLD_PARAM_PREFIX", "ACTION_TYPE", "DISPLAY_NUMBER", "CONFIRM_TEXT", "HOT_KEY"
            ,"SHOW_SEPARATOR_BELOW", "DISPLAY_ON_TOOLBAR", "CHILD_FORM_CODE")
     Values ('APPS_ROLE_USERS', 'UPD', 'APPS_ROLE_USERS_PKG.p_ins_upd', 'Сохранить', '46', '', '', '2', '120'
            ,'Вы уверенны?', '', 'N', 'Y', '');
